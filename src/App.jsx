...
function App() {
  ...
  const data = {
    ...
    hubUrl: "https://hub-hub-juancarlos.npfusf.easypanel.host/",
...
END:VCARD`;
  ...
  const handleDownloadVCard = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'juancarlos_rodriguez.vcf');
    ...
    <div className="hub-container">
      ...
      <section className="profile-section">
        <div className="profile-logo-container">
          <img loading="lazy" src={data.logoUrl} alt={data.name} className="profile-logo-img" onError={(e) => { e.target.src = 'https://ui-avatars.com/api/?name=Juan+Carlos+Rodriguez&background=12C7CF&color=fff&size=200' }} />
        </div>
      </section>
